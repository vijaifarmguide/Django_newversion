...
#pf=pd.read_csv('/home/gaurav/api_data/district_mapped_weather_station123_prcp.csv')
...
def next_7_days_data1(district='None'):
    ...
    if(district!="None"):
        ...
        for i in range(0,7):
            ...
            data.append(inst)
        #print(data)  
        #print(24,datetime.datetime.now())          
        return data
    else:
        alldata=[]
...
def weather_data(district,filter1):
    ...
    #print('hola1',next7[0])
    #print(len(next7))
    all1={"current":dailydata,"future":next7}
    #print(all1)
